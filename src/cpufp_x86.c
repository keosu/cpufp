...
static void thread_func_avx512_fp32(void *params) { cpufp_kernel_x86_avx512f_fp32(); }

static void thread_func_avx512_fp64(void *params) { cpufp_kernel_x86_avx512f_fp64(); }

#ifdef _AVX512_VNNI_
#define AVX512_VNNI_INT8_COMP (0x20000000L * 1280)
static void thread_func_avx512_8b(void *params) { cpufp_kernel_x86_avx512_vnni_8b(); }
#endif
...
void cpufp_x86_avx512(int num_threads) {
  ...
  printf("avx512_vnni int8 perf: %10.4lf gops.\n", perf);
#endif
  ...
  printf("avx512f fp32 perf: %10.4lf gflops.\n", perf);
  ...
  printf("avx512f fp64 perf: %10.4lf gflops.\n", perf);
...
static void thread_func_fma_fp32(void *params) { cpufp_kernel_x86_fma_fp32(); }

static void thread_func_fma_fp64(void *params) { cpufp_kernel_x86_fma_fp64(); }
...
void cpufp_x86_fma(int num_threads) {
  ...
  printf("fma fp32 perf    : %10.4lf gflops.\n", perf);
  ...
  printf("fma fp64 perf    : %10.4lf gflops.\n", perf);
...
static void thread_func_avx_fp32(void *params) { cpufp_kernel_x86_avx_fp32(); }

static void thread_func_avx_fp64(void *params) { cpufp_kernel_x86_avx_fp64(); }
...
void cpufp_x86_avx(int num_threads) {
  ...
  printf("avx fp32 perf    : %10.4lf gflops.\n", perf);
  ...
  printf("avx fp64 perf    : %10.4lf gflops.\n", perf);
...
static void thread_func_sse_fp32(void *params) { cpufp_kernel_x86_sse_fp32(); }

static void thread_func_sse_fp64(void *params) { cpufp_kernel_x86_sse_fp64(); }
...
void cpufp_x86_sse(int num_threads) {
  ...
  printf("sse fp32 perf    : %10.4lf gflops.\n", perf);
  ...
  printf("sse fp64 perf    : %10.4lf gflops.\n", perf);
